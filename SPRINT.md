...
- Compilation **frontend + backend** : `tsc --noEmit` **sans erreur**.
...
| API REST (users, progression, streak) + synchro best-effort | ✅ |
...
## 5. Checklist playtest (séance 10)
...
6. **Architecture & choix techniques** (1 min) — client-serveur découplé, offline-first, Claude via proxy.
